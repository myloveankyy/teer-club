            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-1">
                        ...
                        <Link href={process.env.NEXT_PUBLIC_FRONTEND_URL ? `${process.env.NEXT_PUBLIC_FRONTEND_URL}${p.url}` : `http://localhost:3002${p.url}`} target="_blank" className="text-blue-600 hover:text-blue-800">
