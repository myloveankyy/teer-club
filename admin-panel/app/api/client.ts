...
export const api = {
  ...
  seoDashboard: {
    ...
    bulkUpdate: (data: any) => fetchAPI<{ success: boolean; data: any; error?: string }>("/admin/seo-dashboard/bulk-update", { method: "POST", body: JSON.stringify(data) }),
