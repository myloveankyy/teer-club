            ...
            <main className="flex-1">
                ...
                <section className="bg-white py-16 md:py-24">
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {/* ═══ TRAFFIC GRID — Internal Linking ═══ */}
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-10">
                            <Link href="/common-numbers" className="group flex items-center gap-3 px-4 py-3.5 rounded-xl bg-white border border-gray-200 hover:border-indigo-200 hover:bg-indigo-50/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-indigo-100 text-indigo-600 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 group-hover:shadow-lg group-hover:shadow-indigo-600/20">
                            ...
                            <Link href="/results" className="group flex items-center gap-3 px-4 py-3.5 rounded-xl bg-white border border-gray-200 hover:border-violet-200 hover:bg-violet-50/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-violet-100 text-violet-600 flex items-center justify-center group-hover:bg-violet-600 group-hover:text-white transition-all duration-300 group-hover:shadow-lg group-hover:shadow-violet-600/20">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                                </div>
                                <div className="min-w-0">
                                    <span className="block text-xs font-bold text-gray-900 group-hover:text-violet-700 transition-colors truncate">Results Archive</span>
                                    <span className="block text-[10px] text-gray-400 font-medium">All game history</span>
                                </div>
                            </Link>
                            <Link href="/teer-guide" className="group flex items-center gap-3 px-4 py-3.5 rounded-xl bg-white border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-all duration-300 group-hover:shadow-lg group-hover:shadow-emerald-600/20">
                            ...
                            <Link href="/dreams" className="group flex items-center gap-3 px-4 py-3.5 rounded-xl bg-white border border-gray-200 hover:border-amber-200 hover:bg-amber-50/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-amber-100 text-amber-600 flex items-center justify-center group-hover:bg-amber-600 group-hover:text-white transition-all duration-300 group-hover:shadow-lg group-hover:shadow-amber-600/20">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                            <Link
                                ...
                                className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl border-2 border-gray-200 hover:border-gray-900 text-gray-600 hover:text-gray-900 text-[11px] font-bold uppercase tracking-widest transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 bg-white"
                            >
