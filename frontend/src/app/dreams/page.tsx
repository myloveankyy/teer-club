...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_IN",
    siteName: "Teer Club",
    images: [{ url: "https://teer.club/images/og-default.png", width: 1200, height: 630, alt: "Teer Dream Numbers" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Teer Dream Numbers List",
    description: "Find dream numbers used in Teer games.",
